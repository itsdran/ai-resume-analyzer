...
const Upload = () => {
    ...
    const handleAnalyze = async ({companyName, jobTitle, jobDescription, file}: {companyName: string, jobTitle: string, jobDescription: string, file:File}) => {
        ...
        if (imageFile.error) {
            console.error(imageFile.error); // logs the error to console
            alert(imageFile.error);         // or show a popup, toast, etc.
        }

        if (!imageFile.file) return setStatusText("Error converting the PDF to image.");
        ...
        <main className="bg-[url('/images/bg-main.svg')] bg-cover">
            ...
            <section className="main-section">
                <div className="page-heading py-16">
                    ...
                    ): (<h2>Drop your resume for an ATS application score and improvement tips</h2>)}
                    {!isProcessing && (
